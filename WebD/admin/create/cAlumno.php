...
<html>
    <head> 
        <title>REGISTROAdministrador</title>  
    ...
    <body> 
        ...
        <form action="../create/averdata.php" method = "post"  onsubmit="validate(event)">
            <div class="center">
                ...
                <label for="nomEsc">Nombre de la escuela:</label><br><br>
                ...
                <br>
                <input type="number" id="prom" name="prom" step="0.01" min="0" max="10" required><br><br>
